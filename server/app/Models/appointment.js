...
module.exports ={
    ...
    getAppointmentForDoctor :(params , callback)=>{
        var query = "SELECT userstable.userName , appointment.datea, appointment.startTime, appointment.endtime from ((appointment INNER JOIN doctors ON appointment.doctor_Id = doctors.doctorId)INNER JOIN userstable ON appointment.user_Id = userstable.userId) where doctor_Id = ?"
